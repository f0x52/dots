 ...
 */
//static char font[] = "FantasqueSansMono-Regular.ttf+Powerline+Awesome:pixelsize=21:antialias=true:autohint=true";
//static char font[] = "peep:pixelsize=20:antialias=true:autohint=true";
static char font[] = "peep:pixelsize=18:antialias=true:autohint=true";
